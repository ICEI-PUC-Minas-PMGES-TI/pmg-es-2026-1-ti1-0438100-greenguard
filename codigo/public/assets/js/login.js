...
function renderizarHeader() {
    ...
    if (usuario) {
        // Logado: foto + nome clicável → perfil
...
function logout() {
    encerrarSessao();
    renderizarHeader();
    // Se estiver numa página protegida, volta pra home
    ...
    overlay.innerHTML = `
        <div id="gg-modal-box" style="
            ...
            <div style="display:flex;margin-bottom:24px;border-bottom:2px solid #e0e0e0;">
                <button id="aba-login" onclick="trocarAba('login')" style="
                ...
                <button id="aba-cadastro" onclick="trocarAba('cadastro')" style="
                    flex:1;background:none;border:none;padding:10px;font-family:'Poppins',sans-serif;
